...
class DocumentServiceAWS:
                    ...
                    for doc_id, status, filename, minio_path in stuck_documents:
                        ...
                        if status == 'uploading':
                            ...
                            try:
                                ...
                                asyncio.create_task(self._start_document_processing_aws_safe(doc_id))
                            except Exception:
    ...
    async def _complete_document_processing_sync(self, document_id: str):
        ...
        try:
            ...
            # Run OCR processing (AWS Textract)
    ...
    async def _start_document_processing_aws_safe(self, document_id: str):
        """
