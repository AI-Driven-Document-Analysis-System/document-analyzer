  ...
  if (data.length === 0 && !loading && !error) {
    return (
      <div className="chart-container">
        ...
        <div className="chart-content">
          <div className="no-data">
            <FontAwesomeIcon icon={faDatabase} className="no-data-icon" />
            <p>No upload activity data available</p>
          </div>
        </div>
      </div>
    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            <defs>
              {/* Multi-color gradient for the line */}
              <linearGradient id="multiColorGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#8884d8" />     {/* Purple */}
                <stop offset="25%" stopColor="#82ca9d" />    {/* Green */}
                <stop offset="50%" stopColor="#ffc658" />    {/* Yellow */}
                <stop offset="75%" stopColor="#ff8042" />    {/* Orange */}
                <stop offset="100%" stopColor="#ff6384" />   {/* Pink */}
              </linearGradient>
            ...
            <Line 
              ...
              activeDot={{
                r: 5,
                fill: '#ff6384', // Highlight active dot in pink
                stroke: 'var(--bg-primary)',
                strokeWidth: 2
              }}
              strokeLinecap="round"
              // Optional: add fill for area under line
